			 ...
			 <div class="row" style="padding-left:10px; padding-top: 20px;">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box blue-bg">
						...
						<div class="title" id="fistdata">许可证已过期旅行社</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box brown-bg">
						...
						<div class="title"id="towdata">许可证将过期旅行社</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->	
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box dark-bg">
						...
						<div class="title"id="threedata">旅行社数量</div>						
					</div><!--/.info-box-->			
				</div><!--/.col-->
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="info-box green-bg">
						...
						<div class="title"id="fordata">公司数量</div>						
					</div>		
				</div>				               
			</div>
			<div class="row">
...
<script>
    $(document).ready(function(){
    	...
    	function setTableRowsfist(result){
    		$('#comtow').data('aboutprove',result.aboutprove);
    		if(result.aboutprove == 0 && result.dueapprove == 0 && result.comnumner == 0 && result.talnumner == 0 ){
    			$('#comtow').html("0");
    			$('#comfist').html("0");
    			$('#comthree').html("0");
    			$('#comfor').html("0");
    			...
    			$('#comtow').html(result.aboutprove);
    			$('#comfist').html(result.dueapprove);
    			$('#comthree').html(result.talnumner);
    			$('#comfor').html(result.comnumner);
    		}
    	}
    });
