...
public class OrderNumberUtils {
     ...
     * 起始的时间戳
     */
    private final static long START_STMP = 573813011000L;
    ...
    public OrderNumberUtils(long datacenterId, long machineId) {
    ...
    public static void main(String[] args) {
        OrderNumberUtils snowFlake = new OrderNumberUtils(2, 3);
